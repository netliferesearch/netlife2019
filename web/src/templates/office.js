...
const office = ({ data, pageContext, location }) => {
  ...
  return (
    <>
      <SEO title={name} description={seo?.description || ''} seo={seo} location={location} />
      <Layout breadcrumb={pageContext.breadcrumb}>
        ...
        <div className="mb-16">
          ...
          <div className="pt-16 border-solid border-black border-t">
            <ContactSection heading={title} intro={contactExtra?.contactIntro} persons={persons} form={form} formName={slug?.current} />
          </div>
      </Layout>
    </>
  );
