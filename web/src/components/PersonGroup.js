  ...
  return (
    ...
    >
      <div className="w-full md:w-1/3 sticky md:relative top-0 z-10">
        <div className="block md:inline-block md:text-lg text-md leading-extra-none md:sticky top-0 md:pt-12 pt-4 md:bg-transparent bg-white pb-4 md:pb-0 border-b border-solid border-back md:border-0">
          {groupKey}
        </div>
      </div>
